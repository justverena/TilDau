def generate_feedback(flags: list[str]) -> list[str]:
    ...
    for f in flags:
        if f == "too_fast_tempo":
            ...
            feedback.append("Try speaking a bit faster / Сәл тезірек сөйлеңіз")
        elif f == "too_much_silence":
            feedback.append("Try speaking a bit louder / Сәл қаттырақ сөйлеңіз")
            ...
            feedback.append("Some words may be missing or extra / Кейбір дыбыстар жетіспеуі немесе артық болуы мүмкін")
